...
Public Class frmBranchCriteria
    ...
    Private Sub frmBranchCriteria_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        txtField01.Text = Format(Now(), "yyyy-MM-dd")
    ...
    Private Sub txtField_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtField03.KeyDown, txtField04.KeyDown
        If e.KeyCode = Keys.F3 Or e.KeyCode = Keys.Return Then
            ...
            If Mid(loTxt.Name, 1, 8) = "txtField" Then
                Select Case loIndex
                    Case 3
                        If (txtField03.Text <> "") Then SearchArea(loTxt.Text, False, True)
    ...
    Public Function SearchArea(ByVal fsValue As String _
                            , ByVal fbByCode As Boolean _
                            , ByVal fbIsSrch As Boolean)
        ...
        If fbIsSrch Then
            ...
            If IsNothing(loRow) Then
                Return False
            Else
                txtField03.Text = (loRow.Item("sAreaDesc"))
                txtField03.Tag = (loRow.Item("sAreaCode"))
